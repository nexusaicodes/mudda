...
class Signup::AccountNameGeneratorTest < ActiveSupport::TestCase
  ...
  test "generate" do
    ...
    assert_equal "Newart's Mudda", account_name, "The 1st account doesn't have 1st in the name"
    ...
    account_name = @generator.generate
    assert_equal "Newart's 2nd Mudda", account_name
    ...
    account_name = @generator.generate
    assert_equal "Newart's 3rd Mudda", account_name
    ...
    account_name = @generator.generate
    assert_equal "Newart's 4th Mudda", account_name
    ...
    account_name = @generator.generate
    assert_equal "Newart's 5th Mudda", account_name
  end

  test "generate continues from the previous highest index" do
    account = Account.create!(external_account_id: "12th", name: "Newart's 12th Mudda")
    Current.without_account do
    ...
    account_name = @generator.generate
    assert_equal "Newart's 13th Mudda", account_name
  end
end
