...
module Mudda
  module Saas
    class Engine < ::Rails::Engine
      ...
      initializer "mudda_saas.logging.session" do |app|
      ...
      initializer "mudda_saas.test_mocks", after: :load_config_initializers do
        if Rails.env.test?
          require_relative "testing"
        end
      end

      initializer "mudda_saas.sentry" do
      ...
      initializer "mudda_saas.yabeda" do
