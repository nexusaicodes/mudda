...
#
# Mudda runs one user per deployment. The owner signs in with their email and a deployment
...
module OwnerPassword
  class << self
    # Returns the owner User when password sign-in is available and +password+ matches the
    # deployment secret, otherwise nil.
